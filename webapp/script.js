...
document.getElementById("simulateButton").addEventListener("click", function(event) {
    ...
    console.log("Player Atk Level:", playerAtk);
    console.log("Player Str Level:", playerStr);
    ...
    console.log("Melee Prayer: ", meleePrayer);
    console.log("Defense Prayer:", steelSkin);
    console.log("Halberd:", halberd);
    console.log("Bow:", bow);

...
magePrayer = float(input("Enter Mage Prayer: ")) # multiplier goes here 1.25 for augury, 1.15 for mystic might
rangePrayer = float(input("Enter Range Prayer: ")) # multiplier goes here 1.2 for rigour, 1.15 for eagle eye
defensePrayer = float(input("Enter Defense Prayer: ")) # multiplier goes here 1.25 for augury/rigour, 1.15 for steel skin
